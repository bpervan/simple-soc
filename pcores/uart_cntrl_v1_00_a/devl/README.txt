...
Peripheral Summary:
  ...
  logical library name                       : uart_cntrl_v1_00_a
  top name                                   : uart_cntrl
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/uart_cntrl_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/uart_cntrl_v2_1_0.tcl
